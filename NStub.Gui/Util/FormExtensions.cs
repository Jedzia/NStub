...
namespace NStub.Gui.Util
{
    ...
    public static class FormExtensions
    {
        ...
        /// <param name="eventHandler">The event handler that is attached to the <paramref name="formBackFieldEvent"/>.</param>
        /// <returns>
        /// <c>false</c> if value was <c>null</c> or the same like in the backing field.
        /// </returns>
        ...
        /// <returns><c>false</c> if value was <c>null</c> or the same like in the backing field.</returns>
        ...
        /// </summary>
        /// <param name="value">The control to be added.</param>
        /// <param name="userControlBackField">The backing field for the <see cref="UserControl"/>.</param>
        /// <param name="onLoadEventHandler">The load event handler.</param>
        /// <returns><c>false</c> if value was <c>null</c> or the same like in the backing field.</returns>
