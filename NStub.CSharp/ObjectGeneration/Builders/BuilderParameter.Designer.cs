...
namespace NStub.CSharp.ObjectGeneration.Builders {
    ...
    public partial class BuilderParameter : EmptyBuilderParametersBase<BuilderParameter> {
        
        [EditorBrowsable(EditorBrowsableState.Never)]
        private List<BuilderParameterPropertyBuilder> itemsField;
        
        public List<BuilderParameterPropertyBuilder> Items {
            get {
                if ((this.itemsField == null)) {
                    this.itemsField = new List<BuilderParameterPropertyBuilder>();
                }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    public partial class BuilderParameterPropertyBuilder : EmptyBuilderParametersBase<BuilderParameterPropertyBuilder> {
